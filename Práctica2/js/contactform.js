...
function validatePhone() {
	...
	if(!(/^((00|\+)\d{2})?\d{9}$/.test(phoneNumber))) {
...
function CustomAlert() {
    ...
    this.ok = function () {
		...
		// Si todo ha ido bien, se recarga la página para simular el envío del formulario
		if(document.getElementById('alert_message').innerHTML == thank_message)

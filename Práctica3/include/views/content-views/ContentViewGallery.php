				...
				if($i != 0) {
					echo '
								...
								<a href="#popup'.($i-1).'" class="back">
									<img src="../images/icons/left_arrow.png" alt="'.$gallery['altarrow2'].'" width="40px" height="50%"/>
								</a>';
				}
				if($i != $this->content->getNumImages()-1) {
					echo '
								...
								<a href="#popup'.($i+1).'" class="next">
									<img src="../images/icons/right_arrow.png" alt="'.$gallery['altarrow1'].'" width="40px" height="50%"/>
								</a>';
				}
				echo '		</div>
						</div>';

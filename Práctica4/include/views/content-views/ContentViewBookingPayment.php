					...
					<div class="payment_container">
						...
						<div class="basket">
							...
							<div class="content_reservation">
								<div class="cont">
									<h4 class="cont_name">Habitaciones Individuales: '.$this->content->getSingleRoomNumber().'</h4>									
								</div>
								<div class="cont">
									<h4 class="cont_name">Habitaciones Dobles: '.$this->content->getDoubleRoomNumber().'</h4>									
								</div>
								<div class="cont">
									<h4 class="cont_name">Suites: '.$this->content->getSuiteRoomNumber().'</h4>									
								</div>
								<div class="cont">
									<h4 class="cont_name">Promoción: '.$this->content->getBookingPromName().'</h4>									
								</div>
								<div class="cont">
									<h4 class="cont_name">Desayunos: '.$this->content->getBookingBreakfastNumber().'</h4>									
								</div>
							</div>
							<div class="price">
								<h3>Precio Total: '.$this->content->getTotalPrice().' €</h>
							</div>
						</div>
					</div>
				</div>

...
function stylize() {
  ...
  var i_admin = url_params.search("admin=");
...
// Cambiar el color del borde del elemento pasado por id
function set_border_color(id, color) {
	document.getElementById(id).style.borderColor = color;
}

// Verificar que está correcto - hay introducido usuario y contraseña
function login() {

	if(test_text_login('name') && test_text_login('pass')) {
		var pass = document.getElementById('pass');
		
		var pass_hash = SHA512(pass.value);
		
		pass.value = pass_hash;
		return true;
	}
	else {
		return false;
...
// Encriptar contraseña antes de mandarla al servidor
function SHA512(str) {

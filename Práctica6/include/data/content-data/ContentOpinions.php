<?php
	...
	include 'include/containers/Opinions.php';

	class ContentOpinions {
		
		private $opinionsContainer;
		private $opinions;
		private $finalScore;
		private $cleanScore;
		...
		public function ContentOpinions() {
			...
			$this->opinionsContainer = new Opinions();
			
			$this->opinions = $this->opinionsContainer->getAllOpinions();
			
			for($i=0; $i<count($this->opinions); $i++) {
				$this->opinionDates[$i] = $this->opinions[$i]["opinion_date"];
				$this->opinionAuthors[$i] = $this->opinions[$i]["opinion_author"];
				$this->opinionCountries[$i] = $this->opinions[$i]["opinion_country"];
				$this->opinionCleaningScores[$i] = $this->opinions[$i]["opinion_cleaning_score"];
				$this->opinionAttentionScores[$i] = $this->opinions[$i]["opinion_attention_score"];
				$this->opinionConforScores[$i] = $this->opinions[$i]["opinion_confor_score"];
				$this->opinionLocationScores[$i] = $this->opinions[$i]["opinion_location_score"];
				$this->opinionFacilitiesScores[$i] = $this->opinions[$i]["opinion_facilities_score"];
				$this->opinionBreakfastScores[$i] = $this->opinions[$i]["opinion_breakfast_score"];
				$this->opinionClientMessage1[$i] = $this->opinions[$i]["opinion_message1"];
				$this->opinionClientMessage2[$i] = $this->opinions[$i]["opinion_message2"];
				$this->opinionClientRecommendation[$i] = $this->opinions[$i]["opinion_recommendation"];
			}
